...
public class GetPatientHealthMetricsResponse
{
    public HealthMetricsResponse PatientHealthMetrics { get; set; } = new();
}

public class RecordHealthMetricResponse
{
    public HealthMetricDto RecordHealthMetric { get; set; } = new();
}
